	...
	<body>
		<div class="container">
			...
			<div class="content-proj">
				<h2>About Rhema</h2>
				<p><a href="http://www.cs.rochester.edu/hci/currentprojects.php?proj=rh" target="_blank">Official Project Site</a></p>
				<p><a href="https://www.cs.rochester.edu/hci/pubs/pdfs/rocspeakglass.pdf" target="_blank">The Research Paper: <em>Rhema: A Real-Time In-Situ Intelligent Interface to Help People with Public Speaking</em></a></p>
				...
				<ul>
					<li><a href="http://uonlineblog.blogspot.com/2015/04/blog-post_88.html" target="_blank">Taiwan</a></li>
